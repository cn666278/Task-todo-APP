...
import 'package:youtube_task_app/app/modules/detail/view.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            StepProgressIndicator(
              // TODO used for highlight comment
              // ? 用于判断是否为空，default value is true(null)
              // if the task is not empty, return the items inside
              // otherwise, return 1
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // check the todos is null or not,
